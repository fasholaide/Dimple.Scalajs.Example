...
/** @constructor */
function $c_Lorg_scalajs_dimplejs_DimpleJSExample() {
  $c_O.call(this)
}
$c_Lorg_scalajs_dimplejs_DimpleJSExample.prototype = new $h_O();
$c_Lorg_scalajs_dimplejs_DimpleJSExample.prototype.constructor = $c_Lorg_scalajs_dimplejs_DimpleJSExample;
/** @constructor */
function $h_Lorg_scalajs_dimplejs_DimpleJSExample() {
  /*<skip>*/
}
$h_Lorg_scalajs_dimplejs_DimpleJSExample.prototype = $c_Lorg_scalajs_dimplejs_DimpleJSExample.prototype;
$c_Lorg_scalajs_dimplejs_DimpleJSExample.prototype.init___ = (function() {
  return this
});
$c_Lorg_scalajs_dimplejs_DimpleJSExample.prototype.main__V = (function() {
  var svg = $g.dimple.newSvg("#barContainer", 590, 400);
  var literalData = [{
    "Company": "Google",
    "Awesomeness": "2000"
  }, {
  ...
  var chart = new $g.dimple.chart(svg, literalData);
  chart.addCategoryAxis("x", "Company");
  chart.addMeasureAxis("y", "Awesomeness");
  chart.addSeries(null, $g.dimple.plot.bar);
  chart.draw();
  var callback = (function(tsvData$2) {
    var svg$1 = $g.dimple.newSvg("#lineContainer", 590, 400);
    var jsx$1 = $g.dimple;
    var a = ["Aperture", "Black Mesa"];
    var filteredData = jsx$1.filterData(tsvData$2, "Owner", a);
    var myChart = new $g.dimple.chart(svg$1, filteredData);
    myChart.setBounds(60, 30, 505, 305);
    var x = myChart.addCategoryAxis("x", "Month");
    x.addOrderRule("Date");
    myChart.addMeasureAxis("y", "Unit Sales");
    var x$1 = $g.dimple.plot.line;
    myChart.addSeries((void 0), x$1);
    myChart.draw()
  });
  (0, $g.d3.tsv)("./data/example_data.tsv", callback)
});
$c_Lorg_scalajs_dimplejs_DimpleJSExample.prototype.$$js$exported$meth$main__O = (function() {
  this.main__V()
});
$c_Lorg_scalajs_dimplejs_DimpleJSExample.prototype.main = (function() {
  return this.$$js$exported$meth$main__O()
});
var $d_Lorg_scalajs_dimplejs_DimpleJSExample = new $TypeData().initClass({
  Lorg_scalajs_dimplejs_DimpleJSExample: 0
}, false, "org.scalajs.dimplejs.DimpleJSExample", {
  Lorg_scalajs_dimplejs_DimpleJSExample: 1,
  O: 1,
  sjs_js_JSApp: 1
});
$c_Lorg_scalajs_dimplejs_DimpleJSExample.prototype.$classData = $d_Lorg_scalajs_dimplejs_DimpleJSExample;
$e.org = ($e.org || {});
$e.org.scalajs = ($e.org.scalajs || {});
$e.org.scalajs.dimplejs = ($e.org.scalajs.dimplejs || {});
/** @constructor */
$e.org.scalajs.dimplejs.DimpleJSExample = (function() {
  var $thiz = new $c_Lorg_scalajs_dimplejs_DimpleJSExample();
  $c_Lorg_scalajs_dimplejs_DimpleJSExample.prototype.init___.call($thiz);
  return $thiz
});
$e.org.scalajs.dimplejs.DimpleJSExample.prototype = $c_Lorg_scalajs_dimplejs_DimpleJSExample.prototype;
/** @constructor */
